// ==========================================
// 睿立集團 ERP - 工具專區完整版 (tools-module.js)
// ==========================================
    ...
    container.innerHTML = `
        <div class="space-y-8 max-w-7xl mx-auto pb-12">
            ...
            <div class="space-y-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                    <!-- 地價稅試算 -->
                    <a href="https://net.tax.nat.gov.tw/PLRX/Lrx200d01/trial_lnd.html" target="_blank" rel="noopener noreferrer" class="p-4 bg-white hover:bg-indigo-50/50 border border-stone-200 hover:border-indigo-300 rounded-2xl transition flex items-center space-x-3.5 shadow-2xs group">
                        ...
                        <div class="overflow-hidden flex-1">
                            <div class="font-bold text-xs text-stone-900 truncate">地價稅試算</div>
                            <div class="text-[10px] text-stone-400 truncate mt-0.5">地方稅網路申報</div>
                        </div>
                        <i class="fa-solid fa-arrow-up-right-from-square text-xs text-stone-300 group-hover:text-indigo-600"></i>
                    </a>

                    <!-- 土地增值稅 -->
                    <a href="https://www.etax.nat.gov.tw/etwmain/etw158w/51" target="_blank" rel="noopener noreferrer" class="p-4 bg-white hover:bg-indigo-50/50 border border-stone-200 hover:border-indigo-300 rounded-2xl transition flex items-center space-x-3.5 shadow-2xs group">
                        <div class="w-11 h-11 rounded-xl bg-indigo-100 text-indigo-700 flex items-center justify-center text-base shrink-0 group-hover:scale-105 transition">
                            <i class="fa-solid fa-percent"></i>
                        </div>
                        <div class="overflow-hidden flex-1">
                            <div class="font-bold text-xs text-stone-900 truncate">土地增值稅</div>
                            <div class="text-[10px] text-stone-400 truncate mt-0.5">財政部稅務入口網</div>
                        </div>
                        <i class="fa-solid fa-arrow-up-right-from-square text-xs text-stone-300 group-hover:text-indigo-600"></i>
                    </a>

                    <!-- 房屋稅 (高雄) -->
                    <a href="https://www.kctax.gov.tw/Calculate/HOUCompute2.aspx?1=1&MenuID=1076" target="_blank" rel="noopener noreferrer" class="p-4 bg-white hover:bg-indigo-50/50 border border-stone-200 hover:border-indigo-300 rounded-2xl transition flex items-center space-x-3.5 shadow-2xs group">
                        <div class="w-11 h-11 rounded-xl bg-indigo-100 text-indigo-700 flex items-center justify-center text-base shrink-0 group-hover:scale-105 transition">
                            <i class="fa-solid fa-house"></i>
                        </div>
                        <div class="overflow-hidden flex-1">
                            <div class="font-bold text-xs text-stone-900 truncate">房屋稅 (高雄)</div>
                            <div class="text-[10px] text-stone-400 truncate mt-0.5">高雄市稅捐稽徵處</div>
                        </div>
                        <i class="fa-solid fa-arrow-up-right-from-square text-xs text-stone-300 group-hover:text-indigo-600"></i>
                    </a>

                    <!-- 契稅試算 -->
                    <a href="https://www.etax.nat.gov.tw/etwmain/etw158w/53" target="_blank" rel="noopener noreferrer" class="p-4 bg-white hover:bg-indigo-50/50 border border-stone-200 hover:border-indigo-300 rounded-2xl transition flex items-center space-x-3.5 shadow-2xs group">
                        <div class="w-11 h-11 rounded-xl bg-indigo-100 text-indigo-700 flex items-center justify-center text-base shrink-0 group-hover:scale-105 transition">
                            <i class="fa-solid fa-file-contract"></i>
                        </div>
                        <div class="overflow-hidden flex-1">
                            <div class="font-bold text-xs text-stone-900 truncate">契稅試算</div>
                            <div class="text-[10px] text-stone-400 truncate mt-0.5">財政部稅務入口網</div>
                        </div>
                        <i class="fa-solid fa-arrow-up-right-from-square text-xs text-stone-300 group-hover:text-indigo-600"></i>
                    </a>
                    ...
                    <!-- 地方稅綜合試算 -->
                    <a href="https://net.tax.nat.gov.tw/PLRX/Lrx200d01/trial_cht.html" target="_blank" rel="noopener noreferrer" class="p-4 bg-white hover:bg-indigo-50/50 border border-stone-200 hover:border-indigo-300 rounded-2xl transition flex items-center space-x-3.5 shadow-2xs group">
                        <div class="w-11 h-11 rounded-xl bg-indigo-100 text-indigo-700 flex items-center justify-center text-base shrink-0 group-hover:scale-105 transition">
                            <i class="fa-solid fa-calculator"></i>
                        </div>
                        <div class="overflow-hidden flex-1">
                            <div class="font-bold text-xs text-stone-900 truncate">地方稅綜合試算</div>
                            <div class="text-[10px] text-stone-400 truncate mt-0.5">地方稅申報入口網</div>
                        </div>
                        <i class="fa-solid fa-arrow-up-right-from-square text-xs text-stone-300 group-hover:text-indigo-600"></i>
                    </a>
                </div>
            ...
            <!-- 區塊三：專業評估與試算工具 (已移至不動產稅費試算專區下方) -->
            <div class="space-y-3">
                <div class="flex items-center space-x-2 px-1">
                    <i class="fa-solid fa-sliders text-[#C59B63] text-sm"></i>
                    <h3 class="text-xs font-bold uppercase tracking-wider text-stone-500">專業評估與試算工具</h3>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                    <!-- 1. 土地基本資料 -->
                    <div onclick="if(typeof openLandModal==='function') openLandModal()" class="p-4 bg-white hover:bg-amber-50/50 border border-stone-200 hover:border-amber-300 rounded-2xl transition flex items-center space-x-3.5 shadow-2xs group cursor-pointer">
                        <div class="w-11 h-11 rounded-xl bg-amber-100 text-amber-700 flex items-center justify-center text-base shrink-0 group-hover:scale-105 transition">
                            <i class="fa-solid fa-map"></i>
                        </div>
                        <div class="overflow-hidden flex-1">
                    ...
                    <!-- 2. 保存登記建物 -->
                    <div onclick="if(typeof openRegisteredBuildingModal==='function') openRegisteredBuildingModal()" class="p-4 bg-white hover:bg-sky-50/50 border border-stone-200 hover:border-sky-300 rounded-2xl transition flex items-center space-x-3.5 shadow-2xs group cursor-pointer">
                        <div class="w-11 h-11 rounded-xl bg-sky-100 text-sky-700 flex items-center justify-center text-base shrink-0 group-hover:scale-105 transition">
                            <i class="fa-solid fa-building"></i>
                        </div>
                        <div class="overflow-hidden flex-1">
                    ...
                    <!-- 3. 未保存登記建物 -->
                    <div onclick="if(typeof openUnregisteredBuildingModal==='function') openUnregisteredBuildingModal()" class="p-4 bg-white hover:bg-emerald-50/50 border border-stone-200 hover:border-emerald-300 rounded-2xl transition flex items-center space-x-3.5 shadow-2xs group cursor-pointer">
                        <div class="w-11 h-11 rounded-xl bg-emerald-100 text-emerald-700 flex items-center justify-center text-base shrink-0 group-hover:scale-105 transition">
                    ...
                    <!-- 4. 太陽能試算 -->
                    <div onclick="if(typeof openSolarModal==='function') openSolarModal()" class="p-4 bg-white hover:bg-amber-50/50 border border-stone-200 hover:border-amber-400 rounded-2xl transition flex items-center space-x-3.5 shadow-2xs group cursor-pointer">
                    ...
                    <!-- 5. 土地變更評估 -->
                    <div onclick="if(typeof openLandChangeModal==='function') openLandChangeModal()" class="p-4 bg-white hover:bg-indigo-50/50 border border-stone-200 hover:border-indigo-300 rounded-2xl transition flex items-center space-x-3.5 shadow-2xs group cursor-pointer">
                        <div class="w-11 h-11 rounded-xl bg-indigo-100 text-indigo-700 flex items-center justify-center text-base shrink-0 group-hover:scale-105 transition">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="bg-white p-5 rounded-2xl border border-stone-200 shadow-2xs hover:shadow-md transition flex flex-col justify-between group">
                        ...
                        <div class="pt-3 border-t border-stone-100 flex items-center justify-between">
                            <button type="button" onclick="navigator.clipboard.writeText('https://www.yuanyeh.com.tw/'); alert('📋 已成功複製官網網址！');" class="px-3 py-2 bg-stone-100 hover:bg-stone-200 text-stone-700 border border-stone-200 rounded-xl text-xs font-bold transition flex items-center space-x-1 shadow-2xs cursor-pointer">
                    ...
                    <div class="bg-white p-5 rounded-2xl border border-stone-200 shadow-2xs hover:shadow-md transition flex flex-col justify-between group">
                        ...
                        <div class="pt-3 border-t border-stone-100 flex items-center justify-between">
                            <button type="button" onclick="navigator.clipboard.writeText('https://www.yuanyeh.com.tw/AWS-Backyard/login'); alert('📋 已成功複製後台登入網址！');" class="px-3 py-2 bg-stone-100 hover:bg-stone-200 text-stone-700 border border-stone-200 rounded-xl text-xs font-bold transition flex items-center space-x-1 shadow-2xs cursor-pointer">
                                <i class="fa-solid fa-copy text-[10px]"></i><span>複製網址</span>
                            </button>
...
// 掛載至全域 window，確保 switchModule 可以正確呼叫
window.renderToolsModule = renderToolsModule;
```<FollowUp>重新整理頁面後，排版與樣式是否都符合預期了呢？</FollowUp>
